defmodule LuxWeb.Schemas.Memory do
  use Ecto.Schema
  ...
  schema "memories" do
    ...
    has_many :memory_entries, LuxWeb.Schemas.MemoryEntry
    has_many :agents, LuxWeb.Schemas.Agent, foreign_key: :memory_config_id
  ...
  @type t :: %__MODULE__{
          ...
          position_x: integer(),
          position_y: integer(),
          memory_entries: [LuxWeb.Schemas.MemoryEntry.t()] | Ecto.Association.NotLoaded.t(),
          agents: [LuxWeb.Schemas.Agent.t()] | Ecto.Association.NotLoaded.t(),

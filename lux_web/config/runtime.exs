...
if config_env() == :dev do
  config :lux_web, LuxWeb.Repo,
    ...
    database: env!("POSTGRES_DB", :string, "lux_web_dev"),
...
#
#     PHX_SERVER=true bin/lux_web start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if env!("PHX_SERVER", :boolean, false) do
  config :lux_web, LuxWebWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :lux_web, :dns_cluster_query, env!("DNS_CLUSTER_QUERY", :string, nil)

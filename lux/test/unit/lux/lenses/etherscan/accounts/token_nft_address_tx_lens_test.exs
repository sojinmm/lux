defmodule Lux.Lenses.Etherscan.TokenNftAddressTxTest do
  @moduledoc false
  ...
  describe "before_focus/1" do
    test "sets module and action" do
      ...
      result = TokenNftAddressTx.before_focus(params)
  ...
  describe "after_focus/1" do
    test "processes successful response" do
      ...
      assert {:ok, %{result: [first_transfer | _]}} = TokenNftAddressTx.after_focus(response)
    ...
    test "handles empty transfer list" do
      ...
      assert {:ok, %{result: []}} = TokenNftAddressTx.after_focus(response)
    end
    ...
    test "handles error response" do
      ...
      assert {:error, %{message: "NOTOK", result: "Error! Invalid address format"}} = TokenNftAddressTx.after_focus(response)
    end
  end
end 